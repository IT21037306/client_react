          ...
          <Routes>
            <Route element={<AdminLayout />}>
              ...
              <Route element={<AdminPrivateRoute />}>
                ...
                <Route
                  path="/admin/updateFinances"
                  element={<UpdateFinances />}
                />
                <Route
                  path="/admin/deleteFinances"
                  element={<DeleteFinances />}
                />
                ...
                />
                <Route
                  path="/admin/updateAttendance"
                  element={<UpdateAttendance />}
                />
                <Route
                  path="/admin/deleteAttendance"
